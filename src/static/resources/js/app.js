...
var App = function () {
    ...
    // handle page-sidebar menulist events
    var handleSidebarMenu = function () {

        // handle menu mouseover events
        jQuery('.page-sidebar-menu').on('mouseover', 'li', function (e) {
                // handle menu click events when collapse
                if($('body').hasClass('page-sidebar-closed')==true){
                   $('.etion-menu-collapse-active').removeClass('etion-menu-collapse-active');
                   $(this).addClass("etion-menu-collapse-active");
                 }
        ...
        jQuery('.page-sidebar').on('click', 'li > a', function (e) {
                ...
                if($('body').hasClass('page-sidebar-closed')==true){
                   if ($(this).next().hasClass('sub-menu') == false){
                      ...
                      $('.etion-menu-collapse-active').addClass("active");
                      $(this).parent().addClass("active");
                      return;
                   }
                }
                // handle menu click events when extension
                if ($(this).next().hasClass('sub-menu') == false) {
                    if ($('.btn-navbar').hasClass('collapsed') == false) {
                        $('.btn-navbar').click();
                    }
                    //find only one node menu
                    if($(this).parent().parent().hasClass('page-sidebar-menu')==true){
                    ...
                    {   
                        $('.page-sidebar-menu').children('li.active').removeClass('active');
                        $('.sub-menu').children('li.active').removeClass('active');
                        $('.page-sidebar-menu').children('li.open').addClass("active");
                        $(this).parent().addClass("active");
                    };
        ...
        jQuery('.page-sidebar').on('click', ' li > a.ajaxify', function (e) {
                ...
                var pageContent = $('.etion-page-content');
    ...
    return {
        ...
        blockUI: function (el, centerY) {
           jQuery(el).block({
                            message: "<img src='/static/image/select2-spinner.gif' align=''/><span> 请稍后...</span>",
                            css: { 
                                padding:        0, 
                                margin:         0, 
                                width:          '100px', 
